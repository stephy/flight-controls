...
export const ControlFeedback = observer(() => {
  ...
  return (
    <div {...styles.container}>
      {/* Pull (nose up) */}
      <div
        {...css(styles.overlay, styles.up, { opacity: elevator < -1 ? 1 : 0 })}
      >
        <ArrowUp size={24} />
      ...
      {/* Push (nose down) */}
      <div
        {...css(styles.overlay, styles.down, { opacity: elevator > 1 ? 1 : 0 })}
      >
        <ArrowDown size={24} />
      ...
      {/* Roll left */}
      <div
        {...css(styles.overlay, styles.left, {
      ...
      {/* Roll right */}
      <div
        {...css(styles.overlay, styles.right, {
          opacity: ailerons > 1 ? 1 : 0,
        })}
      >
        <ArrowRight size={24} />
