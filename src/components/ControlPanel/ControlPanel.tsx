...
export const ControlPanel = observer(() => {
  ...
  const handleControlCheck = () => {
    ...
    maxDeflection.current = {
      ailerons: Math.max(
        maxDeflection.current.ailerons,
        Math.abs(store.controls.ailerons)
      ),
      elevator: Math.max(
        maxDeflection.current.elevator,
        Math.abs(store.controls.elevator)
      ),
      rudder: Math.max(
        maxDeflection.current.rudder,
        Math.abs(store.controls.rudder)
      ),
    };
    ...
    <div>
      <div {...styles.section}>
        ...
        <div {...styles.controlGroup}>
          <div {...styles.label}>
            <span>Ailerons</span>
            <span {...styles.value} style={{ color: COLORS.AILERONS }}>
              {formatDegrees(store.controls.ailerons)}°
            </span>
          </div>
          <input
            type="range"
        ...
        <div {...styles.controlGroup}>
          <div {...styles.label}>
            <span>Elevator</span>
            <span {...styles.value} style={{ color: COLORS.ELEVATOR }}>
              {formatDegrees(store.controls.elevator)}°
            </span>
          </div>
          <input
            type="range"
        ...
        <div {...styles.controlGroup}>
          <div {...styles.label}>
            <span>Rudder</span>
            <span {...styles.value} style={{ color: COLORS.RUDDER }}>
              {formatDegrees(store.controls.rudder)}°
            </span>
          </div>
          <input
            type="range"
      ...
      <div {...styles.section}>
        ...
        <div {...styles.controlGroup}>
          <div {...styles.label}>
            <span>Flaps</span>
            <span {...styles.value} style={{ color: COLORS.FLAPS }}>
              {formatDegrees(store.controls.flaps)}°
            </span>
          </div>
        ...
        <div {...styles.controlGroup}>
          <div {...styles.label}>
            <span>Trim Tab</span>
            <span {...styles.value} style={{ color: COLORS.TRIM_TAB }}>
              {formatDegrees(store.controls.trimTab)}°
            </span>
          </div>
          <input
            type="range"
      ...
      <button
        {...styles.resetButton}
        onClick={() => store.controls.resetControls()}
      >
        <RotateCcw size={16} />
        Reset Controls
      </button>
